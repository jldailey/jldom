...
property(HTMLAnchorElement.prototype, 'href', {
  get: function() {
    ...
    path = h.pathname;
    return "" + h.protocol + "//" + host + path + h.search + h.hash;
  },
  set: function(v) {
    var auth, h, hash, hostname, pathname, port, protocol, search, _, _ref, _ref1;
    h = href_init(this);
    _ref1 = (_ref = v.match(href_re)) != null ? _ref : [], _ = _ref1[0], protocol = _ref1[1], auth = _ref1[2], hostname = _ref1[3], port = _ref1[4], pathname = _ref1[5], search = _ref1[6], hash = _ref1[7];
