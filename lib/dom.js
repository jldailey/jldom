...
Event = (function() {
  ...
  Event.prototype.initEvent = function(type, bubbles, cancelable, timeStamp) {
    this.type = type;
...
MouseEvent = (function(_super) {
  ...
  MouseEvent.prototype.initMouseEvent = function(type, bubbles, cancelable, window, detail, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey, button, relatedTarget, timeStamp) {
    this.type = type;
    this.bubbles = bubbles;
    this.cancelable = cancelable;
    this.window = window;
...
Node = (function() {
  ...
  Node.prototype.addEventListener = addEventListener = function(type, listener, useCapture) {
    ...
    list = ((_base = this.listeners[useCapture])[type] != null ? _base[type] : _base[type] = []);
...
ClientRect = (function() {
  function ClientRect() {
    this.width = this.height = this.top = this.left = this.bottom = this.right = 0;
  }
...
Element = (function(_super) {
  ...
  Element.prototype.setAttribute = function(name, value) {
    ...
    return this.attributes[name] = (function() {
      switch (name) {
        case "href":
  ...
  Element.prototype.toString = function(pretty, deep, indentLevel) {
    ...
    attrs = ((function() {
      ...
      _results = [];
      for (a in this.attributes) {
        _results.push(a.length > 0 && ((_ref1 = this.attributes[a]) !== null && _ref1 !== (void 0) && _ref1 !== "") ? " " + a + "=\"" + this.attributes[a] + "\"" : void 0);
      }
      return _results;
    }).call(this)).join('');
    attrs += ((function() {
...
href_init = function(t) {
  var _base;
  return (_base = t._private).href || (_base.href = {
    protocol: "",
    auth: "",
    hostname: "",
    port: "",
...
href_reset = function(t) {
  delete t._private.href;
  return href_init(t);
};

['protocol', 'auth', 'hostname', 'port', 'pathname', 'search', 'hash'].forEach(function(name) {
  return property(HTMLAnchorElement.prototype, name, {
    get: function() {
      return href_init(this)[name];
    },
    set: function(v) {
      return href_init(this)[name] = v;
    }
  });
});

property(HTMLAnchorElement.prototype, 'href', {
  get: function() {
    var h, hash, host, path, protocol, search, _ref, _ref1, _ref2, _ref3;
    h = href_init(this);
    host = h.hostname;
    if (h.port) {
      host += ":" + h.port;
    ...
    protocol = (_ref = h.protocol) != null ? _ref : "";
    if (protocol.length > 0) {
      if (!(/:$/.test(protocol))) {
        protocol += ":";
      }
    }
    path = (_ref1 = h.pathname) != null ? _ref1 : "";
    search = (_ref2 = h.search) != null ? _ref2 : "";
    hash = (_ref3 = h.hash) != null ? _ref3 : "";
    return "" + protocol + host + path + search + hash;
  },
  set: function(v) {
    var auth, h, hash, hostname, m, pathname, port, protocol, search, _, _ref;
    h = href_reset(this);
    if (!/:\/\//.test(v)) {
      if (!/^\/\//.test(v)) {
        v = "//" + v;
    ...
    m = (_ref = v.match(href_re)) != null ? _ref : $.zeros(8).map(function() {
      return "";
    });
    _ = m[0], protocol = m[1], auth = m[2], hostname = m[3], port = m[4], pathname = m[5], search = m[6], hash = m[7];
    auth = auth != null ? auth.replace(/@$/, '') : void 0;
    port = port != null ? port.replace(/^:/, '') : void 0;
    return extend(h, {
      protocol: protocol,
      auth: auth,
      hostname: hostname,
...
CSSPrimitiveValue = (function() {
  function CSSPrimitiveValue(cssText, cssValueType, primitiveType) {
    this.cssText = cssText != null ? cssText : "default";
    this.cssValueType = cssValueType != null ? cssValueType : 1;
    this.primitiveType = primitiveType != null ? primitiveType : 1;
  }

  CSSPrimitiveValue.prototype.getFloatValue = function() {
    return parseFloat(this.cssText);
  };

  CSSPrimitiveValue.prototype.setFloatValue = function(v) {
    return this.cssText = parseFloat(v) + "px";
  };
...
CSSStyleDeclaration = (function() {
  ...
  CSSStyleDeclaration.prototype.getPropertyCSSValue = function(k) {
    var _ref;
    return new CSSPrimitiveValue((_ref = this[k]) != null ? _ref : '');
  };
  ...
  CSSStyleDeclaration.prototype.getPropertyValue = function(k) {
    return this.getPropertyCSSValue(k).cssText;
  };
...
exports.registerGlobals = function(g) {
  ...
  g.NodeList = Array;
  g.Event = Event;
  g.getComputedStyle = function(node) {
    var k, s, v, _ref;
